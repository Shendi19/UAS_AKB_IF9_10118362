...
public class CostumCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListID.setText(cursor.getString(cursor.getColumnIndex(com.example.uas_10118362_shendi.DBHelper.row_id)));
        holder.ListNama.setText(cursor.getString(cursor.getColumnIndex(com.example.uas_10118362_shendi.DBHelper.row_nama)));
    }
